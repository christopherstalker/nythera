...
export default function ChatsPage() {
  ...
  return (
    <PageShell className="codex-chats space-y-12">
      ...
      {loading ? (
        ...
        <div className="grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,.85fr)]">
          <Link href={`/chat/${chats[0].id}`} className="group relative min-h-[430px] overflow-hidden border-y border-[var(--codex-rule)] bg-[var(--codex-paper-raised)] no-underline sm:min-h-[540px]">
