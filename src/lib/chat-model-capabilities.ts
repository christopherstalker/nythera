const NON_CHAT_MODEL =
  /(?:embedding|image|imagen|veo|tts|audio|realtime|transcrib|whisper|moderation|sora|lyria|robotics|computer-use|rerank|gpt-3\.5-turbo-instruct|(?:^|\/)babbage|(?:^|\/)davinci|:batch$)/i;
