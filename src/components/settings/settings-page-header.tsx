  ...
  return (
    <header className="mb-7 border-b border-[var(--border-default)] pb-6 sm:mb-9 sm:pb-8">
      <div className="mb-4 flex items-center gap-3 text-[var(--accent-violet)]">
        ...
        <span className="text-[10px] font-semibold uppercase tracking-[.22em] text-[var(--text-muted)]">Account settings</span>
      </div>
      <h2 className="font-editorial text-[clamp(2.25rem,6vw,3.6rem)] font-medium leading-none text-[var(--text-primary)]">{title}</h2>
