...
export function ChatQuickPanel({ chatId, open, onClose, panel, onNewChat }: ChatQuickPanelProps) {
  ...
  return (
    <aside className="quick-panel glass-depth-panel fixed inset-x-3 bottom-3 top-20 z-40 flex flex-col overflow-hidden rounded-[28px] border md:bottom-4 md:left-auto md:right-4 md:top-24 md:w-[360px] xl:static xl:h-full xl:w-[340px] xl:shrink-0">
