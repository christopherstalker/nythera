...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-3 left-3 z-50 max-w-md rounded-[28px] border border-[var(--border-default)] bg-[var(--bg-surface)] px-2 pb-[calc(0.45rem+env(safe-area-inset-bottom))] pt-2 shadow-[var(--shadow-card)] backdrop-blur-2xl md:hidden"
