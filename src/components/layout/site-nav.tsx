    ...
    <header className="sticky top-0 z-40 border-b border-white/[0.045] bg-background/78 backdrop-blur-2xl">
      <div className="container mx-auto flex h-16 max-w-[1480px] items-center gap-3 px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex shrink-0 items-center gap-2 no-underline">
          <span className="grid h-9 w-9 place-items-center rounded-2xl border border-primary/[0.18] bg-primary/[0.075] text-primary shadow-inset">
            <Bot className="h-5 w-5" />
          </span>
          <span className="hidden text-base font-semibold tracking-tight sm:inline">
            Velora<span className="text-[#cfc6ff]"> AI</span>
          </span>
        </Link>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active && "bg-primary/[0.12] text-[#ded7ff]"
                )}
              >
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {isAuthenticated ? (
            <div className="relative">
              ...
              >
                <span className="grid h-7 w-7 place-items-center rounded-full border border-primary/30 bg-primary/15 text-xs font-bold uppercase text-[#ddd6ff]">
                  {initial}
                </span>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "border-primary/25 bg-primary/[0.12] text-[#ded7ff]" : "hover:bg-white/[0.055] hover:text-foreground"
              )}
            >
